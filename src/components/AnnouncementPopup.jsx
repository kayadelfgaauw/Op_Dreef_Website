...
export default function AnnouncementPopup() {
    ...
    return (
        ...
        >
            ...
            {/* Modal Box */}
            <div 
                className={`relative w-full max-w-2xl bg-brutal-offwhite border-4 border-brutal-black shadow-[8px_8px_0px_0px_#111111] transition-all duration-300 transform flex flex-col z-10 ${
            ...
            >
                ...
                <button
                    onClick={handleClose}
                    className="absolute -top-3 -right-3 md:-top-4 md:-right-4 border-4 border-brutal-black bg-brutal-red text-brutal-black w-10 h-10 flex items-center justify-center hover:bg-brutal-black hover:text-brutal-red transition-all duration-200 hover:rotate-90 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none z-20 cursor-pointer"
                    aria-label="Sluiten"
                >
                ...
                {/* Header Banner */}
                <div className="bg-brutal-red text-brutal-black border-b-4 border-brutal-black p-5 flex items-center gap-4">
                    <div className="bg-brutal-black text-brutal-red p-2 border-2 border-brutal-black rounded-none animate-pulse">
                        <AlertTriangle size={28} strokeWidth={2.5} />
                    </div>
                    <div>
                        <h2 
                            id="announcement-title"
                            className="font-grotesk font-black text-xl md:text-2xl leading-tight uppercase tracking-tight"
                        >
                ...
                {/* Body Content */}
                <div className="p-6 md:p-8 flex flex-col gap-6 font-mono text-brutal-black text-sm md:text-base leading-relaxed">
                    <p className="font-bold border-l-4 border-brutal-red pl-4">
                    ...
                    <p className="font-bold text-center text-lg mt-2 text-brutal-red border-2 border-dashed border-brutal-black py-2 bg-brutal-paper">
